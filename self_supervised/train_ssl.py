...
from self_supervised.augmentations import make_two_views
from self_supervised.contrastive import PointNeXtContrastive, nt_xent_loss
...
def main():
    ...
    parser.add_argument("--out", default="runs/ssl_pointnext_contrastive/best.pt")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch in tqdm(loader, desc=f"Epoch {epoch}"):
            ...
            xyz1, feat1, xyz2, feat2 = make_two_views(xyz, features)
